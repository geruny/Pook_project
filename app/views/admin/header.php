...
<head>
    ...
    <link href="<?= MAIN_PREFIX ?>/app/css/preLoader4.css?<?= rand() ?>" rel="stylesheet">
...
<body>
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?= MAIN_PREFIX . '/' ?>"><span>Lumino</span>Admin</a>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            <li class="<?= Libs\App::getCurPage() == ADMIN_PREFIX . '/' ? "active" : "" ?>"><a href="<?= MAIN_PREFIX ?>/admin"><em class="fa fa-dashboard">&nbsp;</em>Dashboard</a></li>
            <li class="<?= Libs\App::getCurPage() == ADMIN_PREFIX . '/sections' ? "active" : "" ?>"><a href="<?= MAIN_PREFIX ?>/admin/sections"><em class="fa fa-file-text">&nbsp;</em>Категории</a></li>
            <li class="<?= Libs\App::getCurPage() == ADMIN_PREFIX . '/products' ? "active" : "" ?>"><a href="<?= MAIN_PREFIX ?>/admin/products"><em class="fa fa-book">&nbsp;</em>Архив</a></li>
